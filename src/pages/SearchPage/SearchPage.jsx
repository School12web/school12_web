            ...
            <div className={styles.filter} style={{ margin: '1rem 0rem', display: 'flex', gap: '1rem' }}>
                ...
                <div className="checkboxes">
                    <div className="checkbox" style={{display: 'flex', gap: '.45rem'}}>
                        <input type="checkbox" checked={isCheckedFirst} onClick={()=>{setCheckboxState("inc", !isCheckedFirst, false); setFilterType("inc"); console.log(filterType);}}/>
                        <h5>Возрастание</h5>
                    </div>
                    <div className="checkbox" style={{display: 'flex', gap: '.45rem'}}>
                        <input type="checkbox" checked={isCheckedSecond} onClick={()=>{setCheckboxState("dec", false, !isCheckedSecond); setFilterType("dec") ;console.log(filterType);}}/>
                        <h5>Убывание</h5>
                    </div>
                </div>
            </div>
